...
def train_one_epoch(model, optimizer, data_loader, device, epoch, print_freq):
    ...
    for images, targets, ids in metric_logger.log_every(data_loader, print_freq, header):
...
def evaluate(model, data_loader, device):
    ...
    for images, targets, image_ids in metric_logger.log_every(data_loader, 100, header):
